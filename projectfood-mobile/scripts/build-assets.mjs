...
//   node scripts/build-assets.mjs            plants + avatars + stamps + notification icon
...
async function run() {
  ...
  process.stdout.write(`done: ${plantLines.length} plants, ${avatarLines.length} avatars, ${stampLines.length} stamps, ${failed} failed\n`);
