...
async function run() {
  ...
  process.stdout.write(`done: ${plantLines.length} plants, ${avatarLines.length} avatars, ${stampLines.length} stamps, ${cupLines.length} cups, ${categoryLines.length} categories, ${failed} failed\n`);
