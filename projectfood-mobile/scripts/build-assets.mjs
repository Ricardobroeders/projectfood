...
//   node scripts/build-assets.mjs            plants + avatars + notification icon
...
async function run() {
  ...
  process.stdout.write(`done: ${plantLines.length} plants, ${avatarLines.length} avatars, ${failed} failed\n`);
