...
12. Play internal testing → closed testing (12 testers × 14 days); iOS build + TestFlight once Apple is enrolled. Before the listing goes up: reviewer access for the Play and Apple "App access" declaration, a password sign-in for one review account, because reviewers cannot receive the email code (2026-09-21).
