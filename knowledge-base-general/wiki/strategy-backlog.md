...
- **Open:** parent-cluster keyword volumes before content spend (DataForSEO connector still
  ...
  content (class kit, schoolfruit pages) is still wanted, which is row 12's call; de/fr timing.
