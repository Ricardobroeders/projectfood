...
export default async function LeaderboardPage() {
  ...
  return (
    <div className="px-5 pt-4 pb-8 space-y-4">
      <h2 className="text-xl font-extrabold text-[#1F1B16]">Leaderboard</h2>
      <p className="text-[13px] text-[#A39B91] -mt-2">Most unique plants eaten, all time</p>
          ...
          return (
            ...
            >
              ...
              <span className="font-mono text-[14px] text-[#1F1B16] shrink-0">
                {row.unique_plants}
                <span className="text-[#A39B91] text-[12px]"> plants</span>
              </span>
            </div>
          )
        })}
